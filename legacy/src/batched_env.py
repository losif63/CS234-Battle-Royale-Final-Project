...
class BatchedGameEnv:
    ...
    def reset(self, mask=None):
        ...
        # Spawn agents far apart via rejection sampling
    ...
    def step(self, actions: np.ndarray):
        ...
        Args:
            actions: int array shape (num_envs, 2), values 0-8.
        Returns:
        ...
        for agent_id in range(2):
            ...
            for act_idx, vel in _SHOOT_VELS.items():
                ...
                inactive = ~self.bullet_active[shoot_idx]
        ...
        for agent_id in range(2):
            ...
            n_collected = collected.sum(axis=1)
